...
public class RecursionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ViewPager viewPager = findViewById(R.id.recursionViewPager);
        RecursionPagerAdapter pagerAdapter = new RecursionPagerAdapter(getSupportFragmentManager(),tabLayout.getTabCount());
