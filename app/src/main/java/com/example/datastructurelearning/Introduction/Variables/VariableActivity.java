...
public class VariableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ViewPager viewPager = findViewById(R.id.varViewPager);
        VarPagerAdapter pagerAdapter = new VarPagerAdapter(getSupportFragmentManager(),tabLayout.getTabCount());
