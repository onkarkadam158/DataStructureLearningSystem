...
public class ClassActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ViewPager viewPager = findViewById(R.id.classViewPager);
        ClassPagerAdapter pagerAdapter = new ClassPagerAdapter(getSupportFragmentManager(),tabLayout.getTabCount());
