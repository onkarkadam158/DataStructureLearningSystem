...
public class PointerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ViewPager viewPager = findViewById(R.id.pointerViewPager);
        PointerPagerAdapter pagerAdapter = new PointerPagerAdapter(getSupportFragmentManager(),tabLayout.getTabCount());
